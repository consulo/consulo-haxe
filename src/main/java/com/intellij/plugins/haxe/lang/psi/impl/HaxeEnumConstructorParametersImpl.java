...
public class HaxeEnumConstructorParametersImpl extends HaxePsiCompositeElementImpl implements HaxeEnumConstructorParameters {

  public HaxeEnumConstructorParametersImpl(ASTNode node) {
    super(node);
  }
