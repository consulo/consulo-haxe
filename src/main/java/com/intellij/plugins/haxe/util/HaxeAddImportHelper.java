...
public class HaxeAddImportHelper
{
	public static void addImport(String path, PsiFile file)
	{
		...
		while((children[positionIndex] instanceof HaxePackageStatement || UsefulPsiTreeUtil.isWhitespaceOrComment(children[positionIndex]) &&
	...
	{
		final HaxeImportStatementRegular importStatement = HaxeElementGenerator.createImportStatementFromPath(file.getProject(), path);
